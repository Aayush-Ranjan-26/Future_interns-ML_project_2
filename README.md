...
- You can point the pipeline at another CSV by editing `DATA_PATH` in `telco_churn_pipeline.py`.
- For fresh environments, ensure `python --version` is 3.8+ and rerun the pip install above.
